...
internal class RemoteSeasonListAdapter(private val moshi: Moshi) : JsonAdapter<List<RemoteSeason>>() {
    ...
    private val seasonListAdapter by lazy { moshi.adapter<List<TransientSeason>>(seasonType) }
    ...
    internal class TransientSeason(
        ...
        fun toRemoteSeason(showId: Long, episodeList: TransientEpisodeList): RemoteSeason {
            return RemoteSeason(airDate, id, episodeList.episodeList, name, overview, posterPath, showId, seasonNumber)
        }
    }
